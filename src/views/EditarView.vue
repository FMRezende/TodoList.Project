  ...
  <div class="container mt-5">
    ...
    <form @submit.prevent="onFinish" class="mt-3">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="tarea" v-model="formState.tarea"
          :class="{ 'is-invalid': formErrors.tarea }" required />
        <div class="invalid-feedback">{{ formErrors.tarea }}</div>
      </div>
      <button type="submit" class="btn btn-primary" :disabled="databaseStore.loading || formErrors.tarea">
